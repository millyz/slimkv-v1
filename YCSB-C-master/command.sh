...
echo "backup1"
ssh -p ${port_b1} ${user}@${backup1} "cd ~/slimKV/backup1/test ; rm ../parity_sgement/*
rm ../value_sgement/* ; rm ../rocksdb_lsm_0/* ; rm ../rocksdb_lsm_1/* ; rm ../rocksdb_lsm_2/* ; rm ../rocksdb_lsm_3/* ;
./backup -b ${BACKUP_MODE_B} -d mlx5_0 -i 1 -g 3 -n 1 -s -m ${master} -e ${extra0} -E ${extra1} -> ${exp_name}.txt " &

echo "extra0"
ssh -p ${port_e0} ${user}@${extra0} "cd ~/slimKV/extra0/test ; rm ../parity_sgement/*
rm ../value_sgement/* ; rm ../rocksdb_lsm_0/* ; rm ../rocksdb_lsm_1/* ; rm ../rocksdb_lsm_2/* ; rm ../rocksdb_lsm_3/* ;
rm ../rocksdb_lsm/* ;
./extra -d mlx5_0 -i 1 -g 3 -n 0 -c ${backup0} -C ${backup1} -m ${master} -> ${exp_name}.txt " & 

echo "extra1"
ssh -p ${port_e1} ${user}@${extra1} "cd ~/slimKV/extra1/test ; rm ../parity_sgement/*
rm ../value_sgement/* ; rm ../rocksdb_lsm_0/* ; rm ../rocksdb_lsm_1/* ; rm ../rocksdb_lsm_2/* ; rm ../rocksdb_lsm_3/* ;
rm ../rocksdb_lsm/* ;
./extra -d mlx5_0 -i 1 -g 3 -n 1 -c ${backup0} -C ${backup1} -m ${master} -> ${exp_name}.txt " & 

echo "master"
ssh -p ${port_m} ${user}@${master} "cd ~/slimKV/master/test ; 
